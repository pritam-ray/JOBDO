...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'home' | 'companies' | 'add'>('home');

  // Sample company data with coordinates
  const allCompanies: Company[] = [
    {
      ...
      email: "careers@techsolutions.in",
    ...
    },
    {
      ...
      email: "jobs@digitalmarketing.in",
      skills: ["SEO", "Content", "Social Media", "Google Ads", "Analytics"],
      description: "Premier digital marketing agency helping businesses grow online.",
      color: "green",
    ...
    },
    {
      ...
      email: "careers@fintech.in",
      skills: ["Finance", "Analytics", "Java", "Spring Boot", "SQL"],
      description: "Revolutionary fintech startup transforming financial services.",
      color: "purple",
    ...
    },
    {
      ...
      email: "hello@creativedesign.in",
      skills: ["UI/UX", "Graphic Design", "Figma", "Adobe Creative", "Branding"],
    ...
    },
    {
      ...
      phone: "+91-40-3333-2222",
      email: "careers@datasciencelabs.in",
      skills: ["Python", "Machine Learning", "Data Science", "AI", "TensorFlow"],
      description: "Cutting-edge data science company solving complex business problems.",
      color: "indigo",
    ...
    },
    {
      ...
      email: "jobs@ecommerce.in",
      skills: ["PHP", "Laravel", "MySQL", "AWS", "E-commerce"],
      description: "Leading e-commerce platform development company.",
      color: "orange",
